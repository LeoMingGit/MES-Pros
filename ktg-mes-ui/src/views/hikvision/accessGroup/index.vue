<template>
  <div class="app-container">
    <!-- 表头操作 -->
    <el-divider content-position="left">門禁群組</el-divider>
    ...
    <el-form size="mini" inline>
      <el-form-item>
        ...
        <el-button type="primary" v-permission="permission.edit" icon="el-icon-edit" @click="EditAdd" :disabled="!header.group_id">編輯</el-button>
    ...
    <el-form :model="header" class="header">
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="群組編號：">{{ header.group_id }}</el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="群組名稱：">{{ header.group_name }}</el-form-item>
        </el-col>
      </el-row>
      ...
      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="開始日期：">{{ formatDate(header.start_date) }}</el-form-item>
        </el-col>
        <el-col :span="6">
          <el-form-item label="截止有效期：">{{ formatDate(header.exp_date )}}</el-form-item>
        </el-col>
      </el-row>

      <el-row :gutter="20">
        <el-col :span="6">
          <el-form-item label="是否特殊權限：">{{ header.spl_flag_ext }}</el-form-item>
        </el-col>
        <el-col :span="6">
...
import { QueryAccessGroupDetail} from '@/api/hikvision/accessGroup'
...
export default {
  ...
  methods: {
    ...
    showAdd() {
      ...
      this.isAddFlag = true;     
      this.selectRow= { group_id: '', group_name: '', group_name: '',mgr_no:'', spl_flag: 'N',flag:'Y', start_date: null,exp_date:null, remark:"" };
      this.initData();
      this.$refs.add.show();
    },
    ...
    search(searchForm) {
       if (searchForm.group_id) {
        QueryAccessGroupDetail(searchForm.group_id).then((res) => {
          if (res.Status == 1) {
    ...
    initData(){
        ...
        this.selectRow.start_date = currentDate;
        this.selectRow.exp_date = endDate;
     }
