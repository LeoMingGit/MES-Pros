<template>
      ...
      <el-dialog title="編輯角色對應門禁群組" :visible.sync="dialogVisible" width="55%"   
        ...
        <el-form ref="Form" :inline="true" :model="form" :rules="rules" size="small" label-width="66px">
          ...
          <el-form-item label="卡機編號" label-width="100px" prop="mac_no">
            <el-input v-model="form.mac_no"  disabled="disabled"/>
          </el-form-item>
  ...
  import { EditHikAccessDevice,  QueryParentFactoryDict, QueryFunctionDict } from '@/api/hikvision/hikvisionAccessDevice'
    ...
    data() {
      return {
        ...
        rules: {
            ...
            mac_no: [
              { required: true, message: '請輸入卡編號', trigger: 'blur' }
            ],
            mac_name : [
