<template>
    <div class="app-container2">
      ...
      <!--表单组件-->
      <el-dialog title="編輯角色明細" :visible.sync="dialogVisible" width="55%"   
        ...
        <el-form ref="Form" :inline="true" :model="form" :rules="rules" size="small" label-width="66px">
          ...
          <el-form-item label="員工編號" label-width="100px" prop="employee">
            <el-input v-model="form.employee"  disabled="disabled"/>
          </el-form-item>
          <el-form-item label="員工姓名" label-width="100px" prop="emp_name">
            <el-input v-model="form.emp_name"  disabled="disabled"/>
          </el-form-item>
  ...
  import { UpdatePersonToRoleGroup, queryFactoryDict,queryPrincipalList} from '@/api/hikvision/personGroup'
     ...
     handleDialogOpen(){
      ...
      submit() {
        ...
        this.form.insert_user = this.user.id;
         ...
         if (valid) {
          UpdatePersonToRoleGroup(this.form)
              .then((res) => {
                if (res.Status == 1) {
